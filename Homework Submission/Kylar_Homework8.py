...
root.title("Simple Math Calculator")  # Sets the window title
...
calc_button = tk.Button(root, text="Compute", command=calculate)  # Button that does math when clicked
calc_button.grid(row=1, column=0, padx=5, pady=5)

# Step 10: Add the Clear button
clear_button = tk.Button(root, text="Reset", command=clear)  # Button that clears everything when clicked
